...
mod tests {
    ...
    fn test_into_polars() {
        ...
        expect_test::expect![[r#"
            shape: (2, 16)
            ┌────────────┬───────┬───────────────┬───────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┐
            │ Date       ┆ Code  ┆ LongSellValue ┆ ShortSellWith ┆ MarginSellNe ┆ MarginSellCl ┆ LongBuyValue ┆ MarginBuyNew ┆ MarginBuyClo ┆ LongSellVolu ┆ ShortSellWit ┆ MarginSellNe ┆ MarginSellCl ┆ LongBuyVolum ┆ MarginBuyNew ┆ MarginBuyClo │
            │ ---        ┆ ---   ┆ ---           ┆ outMarginValu ┆ wValue       ┆ oseValue     ┆ ---          ┆ Value        ┆ seValue      ┆ me           ┆ houtMarginVo ┆ wVolume      ┆ oseVolume    ┆ e            ┆ Volume       ┆ seVolume     │
            │ date       ┆ cat   ┆ f64           ┆ e             ┆ ---          ┆ ---          ┆ f64          ┆ ---          ┆ ---          ┆ ---          ┆ lume         ┆ ---          ┆ ---          ┆ ---          ┆ ---          ┆ ---          │
