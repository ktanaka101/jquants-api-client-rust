...
///
/// ```no_run
/// use jquants_api_client::{JQuantsBuilder, JQuantsStandardPlanClient, ListedIssueInfoApi, MorningSessionStockPricesApi, TradingByInvestorTypeApi, Paginatable, StockPricesApi};
///
/// async {
