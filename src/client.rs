...
use crate::api::{error_response::ErrorResponse, listed_info::ListedInfoFreePlanResponse};
...
impl JQuantsClient {
    ...
    pub async fn refresh_token(&mut self) -> Result<(), JQuantsError> {
